import 'package:diagflow_chat/models/chat_message.dart';
import 'package:diagflow_chat/widgets/chat_message_list_item.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _sendMessage({String text}) {
    ...
    _addMessage(name: 'Samuel', text: text, type: ChatMessageType.sent);
  }
  ...
  Future _dialogFlowRequest({String query}) async {
    ...
    AuthGoogle authGoogle = await AuthGoogle(fileJson: "assets/agente-vendas-blxtay-7f3c95eea909.json").build();
